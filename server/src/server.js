...
const newPaymentRoutes = require('./routes/payment');
...
app.use(`/api/${process.env.API_VERSION || 'v1'}/payment`, newPaymentRoutes);
app.use(`/api/${process.env.API_VERSION || 'v1'}/affiliate`, affiliateRoutes);
