...
const GoKwikCheckoutPage = () => {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            await checkout(shippingAddress, null);
        } catch (error) {
                        ...
                        {step === 'details' ? (
                            ...
                            <div className="bg-white rounded-lg shadow-sm border p-6">
                                ...
                                <div className="space-y-4 mb-8">
                                    {[
                                        { id: 'upi', name: 'UPI', description: 'GPay, PhonePe, Paytm & more' },
                                        { id: 'card', name: 'Card', description: 'Credit & Debit Cards' },
                                        { id: 'netbanking', name: 'Net Banking', description: 'All Major Banks' },
                                        { id: 'wallet', name: 'Wallets', description: 'Paytm, Mobikwik & more' }
                                    ].map((method) => (
                                        <label
                                            key={method.id}
                                            className={`flex items-center p-4 border rounded-lg cursor-pointer transition-colors ${paymentMethod === method.id ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:border-gray-400'
                                                }`}
                                        >
                                            <input
                                                type="radio"
                                ...
                                <button
                                    ...
                                    className="w-full bg-gray-800 text-white py-4 rounded-lg font-semibold hover:bg-gray-900 transition-colors flex items-center justify-center disabled:opacity-50"
                                >
                                    {processingPayment ? (
                                        <>
                                ...
                                <div className="px-4 pb-4">
                                    ...
                                    <div className="text-center mt-3">
                                        ...
                                        <div className="flex items-center justify-center mt-1">
                                            <span className="font-bold text-blue-600 text-sm">GoKwik</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default GoKwikCheckoutPage;
