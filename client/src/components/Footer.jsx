                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 sm:space-y-2 text-sm sm:text-base">
                            ...
                            <li><a href="/returns-refunds" className="text-gray-300 hover:text-green-400 transition-colors">Returns & Refunds</a></li>
                            <li><a href="/shipping-info" className="text-gray-300 hover:text-green-400 transition-colors">Shipping Info</a></li>
                ...
                <div className="mt-8 pt-6 border-t border-gray-800">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 text-xs">
                            ...
                            <a href="/security" className="text-gray-400 hover:text-saffron-400 transition-colors">Security</a>
                        </div>
                    </div>
                </div>
            </div>
