      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              />
              <div
                className="w-8 h-8 bg-gradient-to-r from-saffron-500 to-green-500 rounded-lg items-center justify-center hidden"
                style={{ display: "none" }}
              >
                <span className="text-white font-bold text-sm">C</span>
              </div>
              <h3 className="text-2xl font-bold bg-gradient-to-r from-saffron-400 to-green-400 bg-clip-text text-transparent">
                Cryptomart
              </h3>
            </div>
          ...
          <div className="text-center">
            ...
            <div className="max-w-md mx-auto flex">
              <input
                ...
                className="flex-1 px-4 py-2 rounded-l-lg border-0 text-gray-900 focus:ring-2 focus:ring-saffron-500 focus:border-transparent"
              />
              <button className="bg-gradient-to-r from-saffron-500 to-saffron-600 text-white px-6 py-2 rounded-r-lg hover:from-saffron-600 hover:to-saffron-700 transition-all duration-200">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">
            © 2024 Cryptomart. All rights reserved. | Made with ❤️ for amazing
